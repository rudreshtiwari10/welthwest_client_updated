            ...
            <div className="relative bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200/50 dark:border-gray-700/50">
              ...
              <div className="px-6 pt-4 pb-6">
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                  ...
                  <a href="https://www.linkedin.com/in/kunal-kumar-25418119a/" target="_blank" rel="noopener noreferrer" className="group/icon w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-700 flex items-center justify-center transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:scale-110" title="LinkedIn">
                    <svg className="w-4 h-4 text-gray-600 dark:text-gray-400 group-hover/icon:text-white transition-colors" fill="currentColor" viewBox="0 0 20 20">
