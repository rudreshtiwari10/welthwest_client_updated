...
import ChatInterfaceNoSave from '../components/ChatInterfaceNoSave';
...
const AssistantIcon: React.FC<{ className?: string }> = ({ className = "h-6 w-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <path d="M4 11h16v5a2 2 0 01-2 2h-5.586l-3.707 2.471A1 1 0 717 19.618V18H6a2 2 0 01-2-2v-5z"/>
  </svg>
);
...
export default WelthAIChatbotPage;