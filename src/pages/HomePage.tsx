    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-dark-300 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
      ...
      <section className="text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link to="/login" className="px-6 py-3 bg-white dark:bg-dark-400 text-gray-800 dark:text-gray-200 font-medium rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-dark-300 transition-colors">
            Sign In
          </Link>
        </div>
      </section>
