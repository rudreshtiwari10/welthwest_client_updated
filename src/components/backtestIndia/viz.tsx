...
export const Card: React.FC<{
  ...
  <section
    className={`rounded-2xl border border-gray-200/70 dark:border-gray-700/50 bg-white/90 dark:bg-background-secondary/80 backdrop-blur-sm p-4 sm:p-5 shadow-[0_10px_30px_-18px_rgba(15,23,42,0.15)] dark:shadow-[0_10px_30px_-18px_rgba(0,0,0,0.4)] ${className}`}
  >
    {(title || right) && (
...
export const StatTile: React.FC<{
  ...
  return (
    <div
      className="rounded-xl border border-gray-200/70 dark:border-gray-700/50 bg-gray-50/70 dark:bg-background-tertiary/70 px-3.5 py-3.5 transition-colors"
      title={hint}
    >
...
export const Note: React.FC<{ children: React.ReactNode; tone?: 'info' | 'warn' }> = ({
  ...
  <p
    className={`mt-3 rounded-lg border-l-2 px-3 py-2.5 text-xs leading-relaxed ${
      tone === 'warn'
        ? 'border-amber-500 bg-amber-500/5 text-amber-700 dark:text-amber-300'
        : 'border-primary-400/60 bg-primary-500/[0.04] text-gray-600 dark:text-gray-300'
    }`}
  >
    {children}
  </p>
